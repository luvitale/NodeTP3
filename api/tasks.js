...
export const doOperation = (num1, num2, op) => {
  ...
  if (!op) return objError
  if (typeof num1 != 'number' || typeof num2 != 'number') return objError

  let ops = { num1, num2, operacion: op }

  switch (op) {
    case "suma": return {
      ...ops, resultado: operations.suma(num1, num2)
    }
    case "resta": return {
      ...ops, resultado: operations.resta(num1, num2)
    }
    case "multiplicación":
    case "multiplicacion": return {
      ...ops, resultado: operations.mult(num1, num2)
    }
    case "división":
    case "division": return num2 == 0 ?
      objError : { ...ops, resultado: operations.div(num1, num2) }
    default: return objError
  }
}